...
3.使用chinadns解决dns污染问题，保证ping外网的时候能正确获得ip，且利用apnic的网址列表来区分国内外。
...
2) 国外网gfw白名单的防火墙配置，依赖dnsmasq，参考：

https://routeragency.com/2019/06/09/v2raye59ca8openwrte4b88be79a84e5ae89e8a385e983a8e7bdb2.html

不管是1)和2），都可以使用同一个v2ray的openwrt客户端配置，其中境外全局模式非常简洁，看起来很舒服。。。
