...
b) gwflist模式，仅对gfwlist挂代理，此方法可以提升路由国内网站访问性能（建议删除v2ray配置文件中的route路由部分）
...
编辑/etc/dnsmasq.conf，github上有很多脚本自动将gfwlist转换为dnsmasq.conf，也可以下个现成的，例如：https://cokebar.github.io/gfwlist2dnsmasq/dnsmasq_gfwlist_ipset.conf，其中部分内容为：
<pre lang="bash" line="0"  colla="+">
