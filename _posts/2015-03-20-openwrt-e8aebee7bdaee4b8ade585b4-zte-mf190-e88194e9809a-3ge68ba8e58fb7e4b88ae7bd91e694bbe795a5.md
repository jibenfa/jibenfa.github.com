...
```vim
Fri Mar 20 12:45:06 2015 daemon.notice pppd[7400]: pppd 2.4.7 started by root, uid 0
...
Fri Mar 20 12:45:08 2015 daemon.notice pppd[7400]: Connect: 3g-3g <--> /dev/ttyUSB2
```
