...
```sh
physdiskwrite.exe -u openwrt-x86-64-combined-ext4.img
```
...
```vim
src/gz chaos_calmer_base http://192.168.1.150/packages/base
...
lo        Link encap:Local Loopback
          ...
          collisions:0 txqueuelen:0
          RX bytes:23183 (22.6 KiB)  TX bytes:23183 (22.6 KiB)
```
