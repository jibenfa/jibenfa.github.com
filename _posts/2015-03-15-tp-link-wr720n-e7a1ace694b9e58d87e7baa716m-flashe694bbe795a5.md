...
dd if=/dev/mtd4 of=art.bin</code></pre>
...
<pre><code class="language-sh">cat u-boot-ar9331-wr720nv3_wr710n.bin openwrt-ar71xx-generic-tl-wr720n-v3-squashfs-factory.bin 12M_FF.bin art.bin &gt; wr720_1407dashenfullflash.bin
