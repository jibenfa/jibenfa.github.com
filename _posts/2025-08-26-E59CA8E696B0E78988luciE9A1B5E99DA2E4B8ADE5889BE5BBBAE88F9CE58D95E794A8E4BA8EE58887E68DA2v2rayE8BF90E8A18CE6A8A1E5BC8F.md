...
1)创建菜单页面（/usr/share/luci/menu.d/luci-app-advancedconfig.json）
```json
{
...
2)创建网页脚本（/www/luci-static/resources/view/advancedconfig.js）
```js
'use strict';
'require view';
'require form';
...
3)创建权限json（/usr/share/rpcd/acl.d/luci-app-advancedconfig.json）
```json
{
